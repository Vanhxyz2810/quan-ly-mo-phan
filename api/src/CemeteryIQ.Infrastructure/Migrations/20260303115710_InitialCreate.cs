        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deceaseds_Plots_PlotId",
                        column: x => x.PlotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenancePlans_Plots_PlotId",
                        column: x => x.PlotId,
                        principalTable: "Plots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NextOfKins_Plots_PlotId",
                        column: x => x.PlotId,
                        principalTable: "Plots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Zones",
                columns: new[] { "Id", "Color", "Cols", "Label", "Name", "Rows" },
                values: new object[,]
                {
                    { "A", "#1B4332", 6, "KHU A", "A", 5 },
                    { "B", "#14532D", 6, "KHU B", "B", 5 },
                    { "C", "#1A3C34", 8, "KHU C", "C", 6 },
                    { "D", "#1B4332", 8, "KHU D", "D", 5 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deceaseds_Name",
                table: "Deceaseds",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_Deceaseds_PlotId",
                table: "Deceaseds",
                column: "PlotId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MaintenancePlans_PlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NextOfKins_PlotId",
                table: "NextOfKins",
                column: "PlotId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Plots_ZoneId_Row_Col",
                table: "Plots",
